...
class ActivityHarvestingPage extends StatefulWidget {
  const ActivityHarvestingPage(
      {super.key,
  ...
  @override
  _ActivityHarvestingPageState createState() => _ActivityHarvestingPageState();

  static Route route(String action, int seasonFarmId, Diary diary,
      ActivityFarm activityFarm, List<ActivityDiary> listActivity, Function(List<ActivityDiary>) onListActivityChanged) {
    return Utils.pageRouteBuilder(
        ActivityHarvestingPage(
...
class _ActivityHarvestingPageState extends State<ActivityHarvestingPage> {
  bool visible = true;
