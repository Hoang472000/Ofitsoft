...
class DetailActivityPage extends StatefulWidget {
  DetailActivityPage({super.key, required this.activityDiary, required this.diary, required this.isEdit});
  ...
  static Route route(ActivityDiary activityDiary, Diary diary, {bool isEdit = true}) {
              ...
              children: [
                Container(
                 /*   decoration: BoxDecoration(
                      color: AppColor.whiteF2.withOpacity(0.2),
                      borderRadius:
