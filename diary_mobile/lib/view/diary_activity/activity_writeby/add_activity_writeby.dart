...
class _AddActWriteByPageState extends State<AddActWriteByPage> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: BlocConsumer<AddActWriteByBloc, AddActWriteByState>(
                  ...
                  children: <Widget>[
                    ListView.builder(
                      ...
                      itemBuilder: (_, index) => ContainerInputWidget(
                        ...
                        onClick: () {
                          setState(() {});
                          blocContext.read<AddActWriteByBloc>().add(
                              OnSelectValueEvent(
