...
import '../../../view_model/diary_activity/record_diary/add_record_diary_bloc.dart';
import '../activity/add_activity_sub/add_activity_sub.dart';

class AddRecordDiaryPage extends StatefulWidget {
  const AddRecordDiaryPage({super.key, required this.action});

  final String action;
  @override
  _AddRecordDiaryPageState createState() => _AddRecordDiaryPageState();

  static Route route(String action) {
    return Utils.pageRouteBuilder(
        AddRecordDiaryPage(action: action),
        true);
  }
}

class _AddRecordDiaryPageState extends State<AddRecordDiaryPage> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AddRecordDiaryBloc(context.read<Repository>())
        ..add(InitAddRecordDiaryEvent(widget.action)),
      child: Scaffold(
        ...
        body: HomeBackGround(
          children: [
            BlocConsumer<AddRecordDiaryBloc, AddRecordDiaryState>(
...
/*              Get.back();
             ...
             /*     decoration: BoxDecoration(
                      ...
                      color: AppColor.whiteF2.withOpacity(0.1)),*/
                      ...
                      children: <Widget>[
                        ListView.builder(
                          ...
                          itemBuilder: (_, index) => ContainerInputWidget(
                            ...
                            onClick: () {
                              setState(() {});
                              blocContext.read<AddRecordDiaryBloc>().add(
                                  OnSelectValueEvent(
