...
class AddActivitySellPage extends StatefulWidget {
  ...
  @override
  _AddActivitySellPageState createState() => _AddActivitySellPageState();

  static Route route(
      int seasonFarmId, List<ActivityDiary> activityDiary, Diary diary) {
...
class _AddActivitySellPageState extends State<AddActivitySellPage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AddActivitySellBloc(context.read<Repository>())
        ..add(InitAddActivitySellEvent(
            widget.seasonFarmId, widget.diary, widget.activityDiary)),
      child: Scaffold(
        ...
        body: BlocConsumer<AddActivitySellBloc, AddActivitySellState>(
