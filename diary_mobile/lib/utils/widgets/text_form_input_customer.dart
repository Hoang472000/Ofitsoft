...
class TextFormFieldInputCustomer extends StatefulWidget {
  final String _label;
  ...
  const TextFormFieldInputCustomer(
      this._label,
...
class _TextFormFieldInputState extends State<TextFormFieldInputCustomer> {
