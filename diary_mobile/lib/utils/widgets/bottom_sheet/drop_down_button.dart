...
class DropDownButtonCustomWidget extends StatefulWidget {
  final List list;
  final int posSelected;
  final String title;
  final bool haveSearch;

  const DropDownButtonCustomWidget(
      {required this.list,
  ...
  @override
  _DropDownButtonCustomWidgetState createState() =>
      _DropDownButtonCustomWidgetState();
}

class _DropDownButtonCustomWidgetState extends State<DropDownButtonCustomWidget> {
  int result = -1;
